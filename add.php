...
if(isset($_POST['add']))
      ...
      echo "<div style ='font:20px;color:black'>Message : $message"; echo "<br>";
      echo "<div style ='font:20px;color:black'>Owner Email : $email" ; echo "<br>";
      
      echo "<div style ='font:20px;color:black'>Create Date : $createdate "; echo "<br>";
      echo "<div style ='font:20px;color:black'>Due Date : $duedate "; echo "<br>";
      echo "<div style ='font:20px;color:black'>Is done : $isdone"; echo "<br>";
